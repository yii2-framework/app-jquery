...
[![build](https://img.shields.io/github/actions/workflow/status/yii2-framework/demo-basic/build.yml?style=for-the-badge&logo=github&label=Build)](https://github.com/yii2-framework/demo-basic/actions?query=workflow%3Abuild)
[![codecov](https://img.shields.io/codecov/c/github/yii2-framework/demo-basic.svg?style=for-the-badge&logo=codecov&logoColor=white&label=Codecov)](https://codecov.io/gh/yii2-framework/demo-basic)
[![Static Analysis](https://img.shields.io/github/actions/workflow/status/yii2-framework/demo-basic/static.yml?style=for-the-badge&label=Static)](https://github.com/yii2-framework/demo-basic/actions/workflows/static.yml)

<picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/images/home-dark.png">
    <source media="(prefers-color-scheme: light)" srcset="docs/images/home-light.png">
    <img src="docs/images/home-light.png" alt="Demo Basic Application">
</picture>

## Docker

[![Apache](https://img.shields.io/github/actions/workflow/status/yii2-framework/demo-basic/docker.yml?style=for-the-badge&logo=apache&label=Apache)](https://github.com/yii2-framework/demo-basic/actions/workflows/docker.yml)
...
```bash
composer create-project --prefer-dist yii2-framework/demo-basic demo-basic
```

Now you should be able to access the application through the following URL, assuming `demo-basic` is the directory
directly under the Web root.

```text
http://localhost/demo-basic/public/
```
